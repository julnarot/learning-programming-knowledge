<%-- 
    Document   : MisArchivos
    Created on : 18/03/2013, 06:20:07 PM
    Author     : JONATAN
--%>
    ...
    <body>
        <div class="container">	
			...
			<div class="codrops-top clearfix">
				...
				<span class="right"><a href=""><strong></strong></a></span>
			</div><!--/ Codrops top bar -->
			<header class="clearfix">
				<h1>Estante Cuadernos</h1>	
				<nav class="codrops-demos">
                                    <a class="current-demo" href="Blocs.jsp">Vista A</a>
				    <a href="#">Add Book</a>
				</nav>
				<span class="support-note">Ingenieria de Sistemas</span>
			</header>
			<div class="main">
