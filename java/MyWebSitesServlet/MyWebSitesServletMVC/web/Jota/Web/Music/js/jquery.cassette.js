...
( function( window, $, undefined ) {
	...
	$.Cassette.defaults 	= {
		// song names. Assumes the path of each song is http://www.fileden.com/files/2010/11/25/3024139/WebSong/songs/name.filetype
		songs			: [ 'pista01', 'pista02', 'pista03', 'pista04' ],
	...
	$.Cassette.prototype 	= {
		...
		_createControls		: function() {
			...
			this.$cSwitch	= $( '<li class="vc-control-switch">Cambiar<span></span></li>' );
		...
		_switchSides		: function() {
			...
			if( this.isMoving ) {
				...
				alert( 'Por favor detenga El reproductor antes de cambiar de posicion.' );
				return false;
...
//                            
				mp3	: 'http://www.fileden.com/files/2010/11/25/3024139/WebSong/songs/' + this.name + '.mp3',
				ogg	: 'http://www.fileden.com/files/2010/11/25/3024139/WebSong/songs/' + this.name + '.ogg'
