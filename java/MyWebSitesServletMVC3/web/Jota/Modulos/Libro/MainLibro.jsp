...
<html>
    ...
    <body style="background-image: url('../../Recursos/Imagenes/Fondos/wood.jpg');">
       <%
     ...
     %>                                    
							...
							<div class="bk-page">
                                                ...
                                                for(MwPaginaTo Toto2: Lista2)
                                                    ...
                                                    %>         
                                                    <a href="../../../LibroController?opt=G&LibroIdJ=<%=Toto.getLibro_id()%>"><img src="../../Recursos/Imagenes/Iconos/Page-Add-128.png" width="20" height="20" title="Nueva Pagina" alt="add" align="right"/></a>
							...
							<div class="bk-left">
								<h2>
                                                                    <span><a href="../../../LibroController?opt=I&LibroIdJ=<%=Toto.getLibro_id()%>"><img src="../../Recursos/Imagenes/Iconos/gear-128.png" width="19" height="21" title="Modificar" alt="modificar" align="right"/></a>
                                                                                <%=Toto.getAutor()%></span>
									<span><%=Toto.getNombre()%></span>
								</h2>
							</div>
