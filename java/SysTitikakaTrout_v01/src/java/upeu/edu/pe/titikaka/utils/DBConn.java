 ...
 */
package upeu.edu.pe.titikaka.utils;
        ...
        try {
            ...
            if (con == null) {
               //con = DriverManager.getConnection(crypt.decrypt("SOQofoD1sZrWEg5izYvRpKhnfWnLLDKGjkm3K8Am/bWwT2NUr06vcA=="), crypt.decrypt("QO3SoaWnsxk="), crypt.decrypt("QO3SoaWnsxk="));
                con = DriverManager.getConnection(crypt.decrypt("SOQofoD1sZrWEg5izYvRpKhnfWnLLDKGjkm3K8Am/bWwT2NUr06vcA=="), crypt.decrypt("OrTFWsnrE08="), crypt.decrypt("LmAJembXM+g="));
