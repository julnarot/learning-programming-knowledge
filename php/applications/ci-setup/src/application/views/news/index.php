...
<div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white el-import"
	 onclick="window.location='<?php echo site_url("News/importar");?>'">
...
<div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white el-element"
	 onclick="location.href='<?php echo base_url(); ?>index.php/news/create'">
	<svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
		 aria-hidden="true">
		<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
			  d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16">
		...
		<div class="col-start-1 row-start-3 space-y-3 px-4">
			...
			<a href="<?php echo site_url('news/' . $news_item['slug']); ?>">
				<button type="button"
						class="bg-violet-100 text-violet-700 text-base font-semibold px-6 py-2 rounded-lg">Show detail
				</button>
			</a>
		...
		<div class="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
			<div class="w-full grid grid-cols-3 grid-rows-2 gap-2">
				<div class="relative col-span-3 row-span-2 md:col-span-2">
					<img src="<?php echo $news_item['urlToImage']?>" alt=""
						 class="absolute inset-0 w-full h-full object-cover bg-gray-100 sm:rounded-lg" Beach House in
						 Collingwood/>
				</div>
